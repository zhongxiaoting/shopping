...
(function( root, factory ) {
    ...
    define('widgets/image',[
        ...
        return Uploader.register({
             ...
             *
             * @method makeThumb
             * @grammar makeThumb( files, callback ) => undefined
             * @grammar makeThumb( files, callback, width, height ) => undefined
             * @for Uploader
             * @example
             *
             ...
             *     var $li = ...;
             *
             *     uploader.makeThumb( files, function( error, ret ) {
             *         if ( error ) {
             *             $li.text('预览错误');
             *         } else {
            ...
            compressImage: function( file ) {
                ...
                image.once( 'complete', function() {
                    ...
                    try {
                        ...
                        // 如果压缩后，比原来还大则不用压缩后的。
                        if ( blob.size < size ) {
                            // files.source.destroy && files.source.destroy();
                            file.source = blob;
                            file.size = blob.size;
    ...
    define('widgets/queue',[
        ...
        return Uploader.register({
            ...
            /**
             * @method addFiles
             * @grammar addFiles( files ) => undefined
            ...
            /**
             * @method removeFile
             * @grammar removeFile( files ) => undefined
    ...
    define('widgets/upload',[
        ...
        Uploader.register({
             ...
             * @grammar skipFile( files ) => undefined
             * @method skipFile
             * @for  Uploader
             */
            ...
            _finishFile: function( file, ret, hds ) {
                ...
                return owner
                        .request( 'after-send-files', arguments, function() {
