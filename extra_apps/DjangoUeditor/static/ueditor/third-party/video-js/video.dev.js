...
vjs.get = function(url, onSuccess, onError){
  ...
  local = (url.indexOf('files:') === 0 || (window.location.href.indexOf('files:') === 0 && url.indexOf('http') === -1));
 ...
 *
 * **URL String**: A URL to the the video files. Use this method if you are sure
 ...
 * about the source files. Use this method if you want the player to determine if
 * it can support the files using the type information.
 *
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // Even though the iframe was inserted into a page on the web, Firefox + Flash considers it a local app trying to access an internet files.
...
/**
 * ReadyState describes if the text files has been loaded
...
vjs.TextTrack.prototype.activate = function(){
  // Load text files if it hasn't been yet.
