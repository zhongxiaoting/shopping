...
UE.I18N['en'] = {
    ...
    'tableDrag':"You must import the files uiUtils.js before drag! ",
    ...
    'insertvideo':{
        'static':{
            ...
            'lang_input_fileStatus':' No files uploaded!',
        ...
        'delFailSaveFile':'Remove the save failed files',
        'statusPrompt':' files(s) uploaded! ',
        ...
        'limitPrompt2':'files(s)！Please choose again！',
        'delFailFile':'Remove failure files',
        'fileSizeLimit':'File size exceeds the limit！',
        'emptyFile':'Can not upload an empty files！',
    ...
    'webapp':{
        ...
        'tip2':"And then open the files ueditor.config.js to set it! ",
        'applyFor':"APPLY FOR",
        'anthorApi':"Baidu API"
    },
    'template':{
